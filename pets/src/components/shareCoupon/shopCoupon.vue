    ...
    <div class="couponListBox">
      ...
      <ul>
        <li class="flex_r_s_b" v-for="(item,index) in couponList" :key="index">
          ...
          <img v-if="item.isReceive==0&&item.couponType!==1&&item.conditionPrice==0" class="imprint" src="../../assets/receiveEnd.png"
            alt="">
          ...
          <img v-if="item.isReceive===1&&item.couponType!=1&&item.conditionPrice==0" class="imprint" src="../../assets/received.png"
            alt="">
          ...
          <img v-if="item.isReceive==0&&item.conditionPrice!=0&&item.couponType!=1" class="imprint" src="../../assets/buyEnd.png"
            alt="">
          <img v-if="item.isReceive==1&&item.conditionPrice!=0&&item.couponType!=1" class="imprint" src="../../assets/buyEnd.png"
            alt="">
        </li>
      </ul>
      ...
      getShopCouponList() {
        ...
        self.axios.post(Api.userApi + '/coupon/selectShopsCoupon', self.qs.stringify({
          ...
          if (res.data.code == 1) {
            ...
            self.navUrl = 'https://uri.amap.com/marker?position=' + res.data.data.longitude + ',' + res.data.data.latitude +
              '&name=' + res.data.data.shopAddress;;
          ...
          if (re.data.code == 1) {
            ...
            WeixinJSBridge.invoke('getBrandWCPayRequest', {
              ...
              if (res.err_msg === 'get_brand_wcpay_request:ok') {
                ...
                alert('支付成功');
                window.location.href = 'https://h5.gumipet.com/index.html#/paySus?type=c&oderNum=' + re.data.data
                  .out_trade_no;
                ...
                alert('取消支付！');
                setTimeout(() => {
                  window.location.href = 'https://h5.gumipet.com/index.html#/shopCoupon?shopId=' + self.shopId +
                    '&sj=' + 10000 * Math.random();
                }, 500)
