			...
			<div class="dilogList flex_r_f_e" @click.stop>
				<div>
					...
					<div class="phone flex_r_s_b">
						...
						<input type="text" @change="inputChange('phone')" v-model="phone">
					</div>
			...
			<li class="flex_r_f_s">
				...
				<div class="realNameList_r">
					<div class="sponsorName">
						<el-input class="goodsNameInput" v-model="companyName" maxlength="60" placeholder="企业/组织全称"></el-input>
					</div>
				</div>
			</li>
			<li class="flex_r_f_s">
				...
				<div class="realNameList_r">
					<div class="sponsorName">
						<el-input class="goodsNameInput" @change="inputChange('businessLicenseNum')" v-model="businessLicenseNum" maxlength="60" placeholder="企业/组织注册号"></el-input>
					</div>
				</div>
			</li>
			<li class="flex_r_f_s">
				...
				<div class="realNameList_r">
					<div class="sponsorName">
						<el-input class="goodsNameInput" v-model="userName" maxlength="60" placeholder="法人(或运营者)姓名"></el-input>
					</div>
				</div>
			</li>
			<li class="flex_r_f_s">
				...
				<div class="realNameList_r">
					<div class="sponsorName">
						<el-input class="goodsNameInput" @change="inputChange('idCard')" v-model="idCard" maxlength="60" placeholder="法人(或运营者)身份证号"></el-input>
					</div>
				</div>
			</li>
		...
		methods:{
			...
			dilogShow(){
				...
				if(this.companyName==''){
					...
					return false;
				}else if(this.businessLicenseNum==''){
					self.$message({
						showClose: true,
						message: '请填企业注册号',
						type: 'error',
